...
import com.incomemanager.api.utils.HttpRequestInterceptor;
import com.incomemanager.api.utils.HttpResponseErrorHandler;
...
public class RestMVCConfig {
    ...
    public OpenAPI openDevAPI() {
        return new OpenAPI().addServersItem(new Server().url("https://dev-api.myincomemanager.com/v1"));
    }
