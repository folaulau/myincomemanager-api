...
public class IncomemanagerApiApplication implements CommandLineRunner {
    ...
    public static void main(String[] args) {
        ...
        SpringApplication.run(IncomemanagerApiApplication.class, args);
    }
    ...
    public CommandLineRunner commandLineRunner(ApplicationContext ctx) {
        return args -> {
            ...
            try {
                ...
                System.out.println("************************ IncomeManager API ***************************");
