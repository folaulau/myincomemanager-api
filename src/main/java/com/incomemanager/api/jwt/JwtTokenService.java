package com.incomemanager.api.jwt;
...
public class JwtTokenService {
    ...
    private static final String      secret            = "hasuraapi-hasuraapi-hasuraapi-hasuraapi-hasuraapi-hasuraapi";
    ...
    public String generateToken(User user) {
        ...
        try {
            ...
            hasura.put("x-Hasura-account-id", user.getAccount().getId()+"");
            hasura.put("x-Hasura-account-uuid", user.getAccount().getUuid());
